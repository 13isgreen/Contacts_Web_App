...
<body>
  <div class="studio-image">
    ...
    <!-- CONTACTS PANEL -->
    <div class="contact-panel mx-auto mt-4">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a href="delete_contactnb.php?id=<?php echo $row['ID']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
            </td>
          </tr>
          <?php endwhile; ?>
        </tbody>
